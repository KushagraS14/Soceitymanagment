           ...
           <li><a href="home.php"> Home</a></li>
              ...
              <div class="flex justify-center bg-gradient-to-r from-blue-700 via-blue-800 to-stone-900 p-4 animate__animated animate__fadeIn">
               <div class="flex flex-col justify-center items-center animate__animated animate__slideInDown">
                  ...
                  class="text-3xl font-bold text-stone-700 text-center md:-ml-24">  Literature Society </div>
                  ...
                  <div class="flex flex-col md:flex-row   items-center justify-center   mx-10">
                      ...
                      <img src="images/literature.png" alt=".../"  width="800" height="700"
                     class="rounded-full" />
                     </div>
                     </div>
                     </div>                       
...
appreciation for myriad literary expressions, forms and genres.
                   ...
                   <?php
                   if("https://sites.google.com/thapar.edu/litsoc/home" !="")
                 {
                     echo
                     '
                   <div style="color:black; font-weight:bold;"><a href="https://sites.google.com/thapar.edu/litsoc/home">more...</a></div>
          ...
          <h2 style="color:white; text-decoration:underline; text-align:centre; margin-top:20px; font-size:30px;font-weight:bold" 
              ...
              <p class="text-white">Total Members = <?php 
                          $p ="select count(*) as count from members where society= 'Literature Society' ";
          ...
          $sql ="select * from `members` where society='Literature Society' ";
          ...
          <br>
                ...
                <div style="background-color:black;">
                          ...
                          $p ="select count(*) as count from events where society='Literature Society'";
                           $result= mysqli_query($conn,$p);
                            $row = mysqli_fetch_assoc($result); 
                            echo $row["count"];?></p>
                      ...
                      $sql ="Select * from events  where society='Literature Society'order by start_date,time";
                      $result = mysqli_query($conn,$sql);
                       $count=1;
                      if($result){
                          while($row=mysqli_fetch_assoc($result))
